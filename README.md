...
* Led technical discussions to optimize our ETL application for high concurrency. This involved a critical shift from synchronous REST calls to an asynchronous messaging approach using AWS SQS. This transformation yielded significant benefits, including improved application stability, faster processing times, enhanced performance metrics, and a remarkable 95% reduction in customer-reported incidents.
* Automated infrastructure and application deployments in the cloud using Infrastructure as Code (IaC) principles. Leveraged Terraform to provision AWS resources and Helmfile to manage Kubernetes deployments, streamlining the deployment process and ensuring consistency.
...
* Implemented coding standards and industry best practices framework to enhance code quality across codebase; reduced bug count by 40% and increased overall project efficiency by 25%.
* Established a culture of proactive security as the security liaison. I spearheaded security incident response, coordinated vulnerability assessments leveraging SAST, SCA, and DAST tools to identify CVEs, and managed their resolution. 
...
* Reduced service latency by 80% through architectural improvements. This included migrating from a synchronous REST API model to an asynchronous messaging approach using Apache Kafka. Additionally, I implemented GraphQL to optimize data fetching and eliminate unnecessary nested REST calls, effectively promoting a more centralized data access approach, which aligns with the principles of the aggregator pattern and further contributes to improved overall system efficiency.
* Led the migration of over 150 microservices from Mesos to Kubernetes.
* Designed, developed, debugged, and deployed conversational experiences and solutions using the RASA framework. I also developed Python APIs to fetch and enrich data from various sources, enabling chatbots to provide more comprehensive and informative responses.
> _Java, Spring Boot, Microservices, Spring Cloud, Spring Data JPA, AWS (KMS, S3, DynamoDB, RDS, EC2, SQS), Apache Kafka, Kafka Streams,Thrift, Docker, Jenkins, Maven, GIT, JSON, Restful API, Agile Development, Architecture, Containerization, Design Patterns, DevOps, Disaster Recovery, Distributed Systems, IAAS, Infrastructure as a Service, Load Balancing, Mentoring, Migration, SAAS, Redis, Elasticache, Terraform, Infrastructure as Code, OAuth, Middleware, Rasa, Python, chatbots, conversational AI, Splunk, Scrum, Prometheus, JDBC, Web Application Security, Product Requirements, Problem Solving, Spring MVC, Debugging, Agile Methodologies, Performance optimization_
